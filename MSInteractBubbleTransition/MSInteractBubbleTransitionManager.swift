...
final class MSInteractBubbleTransitionManager : UIPercentDrivenInteractiveTransition{
    var delegate: MSInteractBubbleTransitionDelegate?
    ...
    func setPanToDismissGesture(view:UIView){
